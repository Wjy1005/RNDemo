...
import GiftedListView from './lib';
    ...
    _emptyView(refreshCallback) {
        ...
        return (
            <View style={{
                ...
                justifyContent: 'center', backgroundColor: 'white', marginTop:50
            }}>
                <Image source={require('../img/icon_nodata.png')}/>
                <Text style={{marginTop: 20, color:'#d9d9d9'}}>暂无数据</Text>
            </View>
        );
    }

    _onEndReached() {
        //console.log(this._pagnateCallback);

...
var GiftedListView = React.createClass({
  ...
  propTypes: {
    ...
    paginationFetchingView: React.PropTypes.func,  // (firstLoaderHide)=>void
    paginationAllLoadedView: React.PropTypes.func, // (void)=>void
    paginationWaitingView: React.PropTypes.func,  // (this._onPaginate)=>void
    emptyView: React.PropTypes.func,   // (this._onRefresh)=>void
